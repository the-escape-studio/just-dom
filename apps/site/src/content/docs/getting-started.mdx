...
Prefer a full **Vite** project with **`jd.config`** already wired? Run **`npm create just-dom@latest`** — see **[Installation](/docs/installation#new-vite-project-cli)** and **[App setup](/docs/jd-config#start-a-new-project)** for prompts and flags (`--js`, `--no-router`, `--pnpm`, …).
