// @ts-nocheck
import * as __fd_glob_20 from "../src/content/docs/plugin-api/with-plugins.mdx?collection=docs"
import * as __fd_glob_19 from "../src/content/docs/plugin-api/define-plugin.mdx?collection=docs"
import * as __fd_glob_18 from "../src/content/docs/official-plugins/signals.mdx?collection=docs"
