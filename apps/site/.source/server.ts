// @ts-nocheck
import * as __fd_glob_20 from "../src/content/docs/official-plugins/signals.mdx?collection=docs"
import * as __fd_glob_19 from "../src/content/docs/official-plugins/router.mdx?collection=docs"
import * as __fd_glob_18 from "../src/content/docs/official-plugins/lucide.mdx?collection=docs"
...
export const docs = await create.docs("docs", "src/content/docs", {"meta.json": __fd_glob_0, "core-api/meta.json": __fd_glob_1, "official-plugins/meta.json": __fd_glob_2, "plugin-api/meta.json": __fd_glob_3, }, {"create-a-plugin.mdx": __fd_glob_4, "getting-started.mdx": __fd_glob_5, "index.mdx": __fd_glob_6, "installation.mdx": __fd_glob_7, "jd-config.mdx": __fd_glob_8, "typescript.mdx": __fd_glob_9, "core-api/create-el-from-html-string.mdx": __fd_glob_10, "core-api/create-element.mdx": __fd_glob_11, "core-api/create-fragment.mdx": __fd_glob_12, "core-api/create-ref.mdx": __fd_glob_13, "core-api/create-root.mdx": __fd_glob_14, "core-api/dom-object.mdx": __fd_glob_15, "plugin-api/define-plugin.mdx": __fd_glob_16, "plugin-api/with-plugins.mdx": __fd_glob_17, "official-plugins/lucide.mdx": __fd_glob_18, "official-plugins/router.mdx": __fd_glob_19, "official-plugins/signals.mdx": __fd_glob_20, });